...
DiscordForge provisions resources after you create the server and bot manually.
...
10. Move the bot role above every role DiscordForge should manage.

## Onboarding Fallback

Discord onboarding prompts are not fully exposed as a stable provisioning surface in `discord.js`. DiscordForge writes onboarding questions to the blueprint and logs a manual fallback. Apply them in Discord under Server Settings > Onboarding.
